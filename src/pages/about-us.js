...
export default function Page() {
    return (
      <InnerPageContainer title="About Us">
           <p>Once upon a time, in the heart of the bustling, vibrant city of Hong Kong, a passionate artist named Warren Chiu dreamed of sharing the profound beauty and unique essence of Asian artistry with the world. He was particularly enamored with the iconic skyline of his beloved city, a majestic blend of modernity and tradition that seemed to paint the sky with its silhouettes each dawn and dusk.
            </p>

            <p className="mt-8">
            Warren believed that each building told a story, each contour of the skyline was a stroke of a brush that narrated the tale of cultural confluence. This imagery inspired him to create a platform where the strokes of many other brushes could tell their tales too. He envisioned a space where artists from across Asia could come together to paint the canvas of the world with their rich, diverse cultural experiences.
            </p>
